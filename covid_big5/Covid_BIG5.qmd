...
Recoding the variables that were answered in the opposite form
...
# plotting the number of confirmed cases a 14 days after first 50 cases, by avrage score on the big five diffrent factors.
...
# Filtering out China
filtering out China because is an outlier, where the outbreak started.
```{r}
