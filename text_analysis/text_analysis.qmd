...
1. The likelihood of each token to appear in documents of each class is calculated from the training data. For example, if the word *giveaway* appeared in $11$% of the documents in the first class, and in $2$% of the documents in the second class, the likelihood of it in each class is:\
$$
